...
import MobileRacing from "./pages/MobileRacing";
...
// Create QueryClient with minimal configuration to prevent errors
        ...
        <SimpleThemeProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/mobile-racing" element={<MobileRacing />} />
              <Route path="/advanced-ai" element={<AdvancedAI />} />
              <Route
                path="/commercial-platform"
                element={<CommercialPlatform />}
              />
